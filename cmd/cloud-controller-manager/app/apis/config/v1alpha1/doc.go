...
// +k8s:conversion-gen=k8s.io/cloud-provider-gcp/cmd/cloud-controller-manager/app/apis/config
...
package v1alpha1 // import "k8s.io/cloud-provider-gcp/cmd/cloud-controller-manager/app/apis/config/v1alpha1"
